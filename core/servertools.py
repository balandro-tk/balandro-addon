...
def corregir_servidor(servidor):
    ...
    elif servidor in ['streamta.pe', 'strtapeadblock', 'streamtapeadblock', 'adblockstrtech', 'adblockstrtape', 'adblockstreamtape', 'playstp', 'strcloud', 'strtpe', 'stape']: return 'streamtape'
    elif servidor in ['sbembed2', 'sbvideo']: return 'sbembed'
    elif servidor in ['streams1', 'streams2']: return 'streams3'
    elif servidor in ['sbplay', 'sbplay1', 'sbplay2', 'pelistop', 'sbfast', 'cloudemb', 'tubesb', 'sbembed', 'embedsb' ,'sbembed.com', 'playersb', 'sbcloud1', 'watchsb', 'viewsb']: return 'streamsb'
    ...
    elif servidor in ['voesx']: return 'voe'
